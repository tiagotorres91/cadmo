...
- **Track** — nobody has to ask "how's it going": a board shows it, a daily async pass surfaces what's urgent, and a short status report keeps the client seeing progress.
